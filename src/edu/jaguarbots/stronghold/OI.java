...
import edu.jaguarbots.stronghold.commands.climber.Down;
import edu.jaguarbots.stronghold.commands.climber.Grab;
import edu.jaguarbots.stronghold.commands.drive.GearShiftHigh;
...
public class OI {
	public OI() throws InterruptedException {
		 Manipulator_L1.whileHeld(new Output());							//1
//		 Manipulator_L3.whenPressed(command);
		 Manipulator_R1.whileHeld(new Intake());							//2
		 Manipulator_R3.whenPressed(new IntakeMiddle());					//3
//		 if(Manipulator_L2.get() == true){
		 Manipulator_R2.whenPressed(new ShooterFire());					//4
//		 }
		 Manipulator_Start.whenPressed(new Down());
		 Manipulator_Select.whenPressed(new Grab());						//5
//		 Manipulator_DpadLeft.whenPressed(command);
//		 Manipulator_DpadRight.whenPressed(command);
		 Manipulator_DpadUp.whenPressed(new ShooterUp());					//6
		 Manipulator_DpadDown.whenPressed(new ShooterDown());				//7
...
//	 */
//	public final Button Manipulator_A = new JoystickButton(Manipulator, 1);
//	/**
//	 * Manipulator Left stick button. Press the stick to activate
//	 */
//	public final Button Manipulator_B = new JoystickButton(Manipulator, 2);
//	/**
//	 * Manipulator Right stick button. Press the Stick to activate
//	 */
//	public final Button Manipulator_XButton = new JoystickButton(Manipulator, 3);
//	/**
//	 * Manipulator Start button
//	 */
//	public final Button Manipulator_YButton = new JoystickButton(Manipulator, 4);
//	/**
//	 * Manipulator Dpad up button
//	 */
//	public final Button Manipulator_LB = new JoystickButton(Manipulator, 5);
//	/**
//	 * Manipulator Dpad right button
//	 */
//	public final Button Manipulator_RB = new JoystickButton(Manipulator, 6);
//	/**
//	 * Manipulator Dpad down button
//	 */
//	public final Button Manipulator_Back = new JoystickButton(Manipulator, 7);
//	/**
//	 * Manipulator Dpad left button
//	 */
//	public final Button Manipulator_Start = new JoystickButton(Manipulator, 8);
//	/**
//	 * Manipulator Left trigger
//	 */
//	public final Button Manipulator_LStick = new JoystickButton(Manipulator, 9);
//	/**
//	 * Manipulator Right trigger
//	 */
//	public final Button Manipulator_RStick = new JoystickButton(Manipulator, 10);
//	/**
